...
| 9 conformance | `/conformance` | "This is the only screen about what the runtime actually did, compared with the Policy we adopted." | 86 findings, conformance resultHash `42318e75…1863` (`remeasure:adoption-journey`, step 9); violation 3 groups / 6 Actions and under_asked 83 groups / 959 Actions (`remeasure:conformance-findings` in `docs/evidence/conformance.md`) |
