...
| 9 conformance | `/conformance` | "This is the only screen about what the runtime actually did, compared with the Policy we adopted." | 86 findings, conformance resultHash `898affd1…1ca8` (`remeasure:adoption-journey`, step 9); violation and under_asked rows |
...
Recording proceeds from tag `evidence-2026-09-24-classifier-0.2.6`, the evidence snapshot these figures come from.
