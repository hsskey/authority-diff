...
- **Not built in V1.** Enforcing or rolling back a Policy Version, settings export, API tokens and roles, provider calibration, a Codex parser, and the other work listed in `docs/cutline.md` chapter 13 are out of scope.
